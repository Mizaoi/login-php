...
// Fungsi: Dashboard Admin dengan style Air Terjun Tancak
...
$query_admin = mysqli_query($koneksi, "SELECT * FROM tb_login WHERE username = '$username'");
$admin = mysqli_fetch_assoc($query_admin);

// Hitung statistik tiket (data statis sesuai gambar)
$belum_checkin = 1;
$masih_wisata = 1;
$sudah_pulang = 6;
$total_tiket = $belum_checkin + $masih_wisata + $sudah_pulang;
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Dashboard Admin - Air Terjun Tancak</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        /* ========== NAVBAR UTAMA (style Air Terjun Tancak) ========== */
        .navbar {
...
<!-- NAVBAR - style Air Terjun Tancak seperti gambar -->
<div class="navbar">
    <div class="logo">
...
<div class="dashboard-container">
    ...
    <!-- Kartu Statistik seperti di gambar cuplikan layar -->
    <div class="stats-grid">
        <div class="stat-card">
            <div class="stat-icon">🎫</div>
            <div class="stat-info">
                <h3>Belum Check-in</h3>
                <p class="stat-number"><?= $belum_checkin ?> tiket</p>
            </div>
        </div>
        <div class="stat-card">
            <div class="stat-icon">🚶</div>
            <div class="stat-info">
                ...
                <p class="stat-number"><?= $masih_wisata ?> tiket</p>
            </div>
        </div>
        <div class="stat-card">
            <div class="stat-icon">🏠</div>
            <div class="stat-info">
                <h3>Sudah Pulang</h3>
                <p class="stat-number"><?= $sudah_pulang ?> tiket</p>
            </div>
        </div>
    </div>
